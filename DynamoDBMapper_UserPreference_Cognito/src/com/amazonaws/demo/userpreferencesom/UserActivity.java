...
import com.amazonaws.demo.userpreferencesom.DynamoDBManager.RequestedDishes;

public class UserActivity extends Activity {

    private String userID = "";
    //private UserPreference userInfo = null;
    private RequestedDishes requestedDishes = null;
    ...
    private void setupActivity() {
        ...
        String dishName = requestedDishes.getDishName() + " - " + requestedDishes.getUserID();
        final TextView textViewUserName = (TextView) findViewById(R.id.textViewUserName);
        textViewUserName.setText(dishName);
    ...
    private class GetUserInfoTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            requestedDishes = DynamoDBManager.getCustomerRequestedDishes(userID);
            return null;
        }
    ...
    private class UpdateAttributeTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            DynamoDBManager.updateUserPreference(requestedDishes);
