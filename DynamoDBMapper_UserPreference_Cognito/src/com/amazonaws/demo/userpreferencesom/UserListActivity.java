...
public class UserListActivity extends ListActivity {
    ...
    private ArrayList<RequestedDishes> items = null;
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra("USER_NO", items.get(position).getRequestID() + "");
    ...
    private class GetUserListTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... inputs) {
            ...
            items = DynamoDBManager.getAllRequestedDishesist();

            for (RequestedDishes up : items) {
                labels.add(up.getDishName() + " - " + up.getUserID());
            }
